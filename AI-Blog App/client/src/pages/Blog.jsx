...
<textarea onChange={(e)=>setName(e.target.value)} value={name} placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none h-48' required></textarea>
...
<div className='my-24 max-w-3xl mx-auto'>
  ...
  <div className='flex'>
  <img src={assets.whatsapp_icon} width={50} alt="" />
  <img src={assets.github_icon} width={50} alt="" />
  <img src={assets.linkedin_icon} width={50} alt="" />
  </div>
</div>
      </div>
   <Footer/>
