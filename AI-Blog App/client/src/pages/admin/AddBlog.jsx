...
<button  disabled={loading} onClick={generateContent}
className='absolute bottom-1 right-2 ml-2 text-xs text-white bg-primary/100 px-4 py-1.5 rounded hover:underline cursor-pointer'
type='submit' >Generate with AI</button>
</div>
